...
export default function OnboardingPage() {
  ...
  const [form, setForm] = useState({ name: 'Raka', currency: 'IDR', budgetStartDay: 1, accountName: 'Rekening utama', accountType: 'Rekening bank', initialBalance: 0, budgetName: 'Makan & Minum', budgetAmount: 3000000 })
